...
//    private Rect menuPos;
    ...
    public PikaSprite(Context context, Pikamon pikamon, int numberOfSprites) {
        super();
//        this.numberOfSprites = NUMBER_OF_ANIMATIONS;
        ...
        double targetWidth = canvasWidth / 4f;
        double currentWidth = image.getWidth() / (float) numberOfSprites;
