...
public class StartMenu {
    ...
    private void initialiseButtons(Context context) {
        ...
        for (String buttonName : BUTTON_NAMES) {
            ...
            switch(buttonName) {
                case "Pikamon":
                    buttons[buttonCount] = new PikamonButton(context, new int[]{buttonX, buttonY}, buttonWidth, buttonHeight);
                    break;
                case "Back":
                    buttons[buttonCount] = new BackButton(context, new int[]{buttonX, buttonY}, buttonWidth, buttonHeight);
                    break;
                default:
